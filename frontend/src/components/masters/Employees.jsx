...
//     if(validated){
//       if(data.id == 0){
//         axios.post(apiUrl + "employees", data).then((res)=>{
//           if(res.data.status == "success"){
//             load();
//           }else{
...
//       }
//       else{
//         axios.put(apiUrl + "employees/" + data.id, data).then((res)=>{
//           if(res.data.status == "success"){
//             load();
//           }else{
//             alert(res.data.data.sqlMessage);
...
//                   </div>
//                   <div class="col-lg-8">
//                     <label class="form-label">Address*<span class="small text-danger">{dataError.address}</span></label>
//                     <input type="text" class="form-control" id="address" value={data.address} onChange={(e)=>{ handleChange(e); }}/>
//                   </div>
//                   <div class="col-lg-4">
//                     <label class="form-label">Mobile No*<span class="small text-danger">{dataError.mobileno}</span></label>
//                     <input type="text" class="form-control" id="mobileno" value={data.mobileno} onChange={(e)=>{ handleChange(e); }}/>
//                   </div>
//                   <div class="col-lg-4">
//                     <label class="form-label">Username*<span class="small text-danger">{dataError.username}</span></label>
//                     <input type="text" class="form-control" id="username" value={data.username} onChange={(e)=>{ handleChange(e); }}/>
//                   </div>
//                   <div class="col-lg-4">
//                     <label class="form-label">Password*<span class="small text-danger">{dataError.password}</span></label>
//                     <input type="text" class="form-control" id="password" value={data.password} onChange={(e)=>{ handleChange(e); }}/>
//                   </div>
//                   <div class="col-lg-12">
